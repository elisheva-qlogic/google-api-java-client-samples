...
public class TestInstanceGroupRestructured {
  ...
  private static InstanceGroupRestructured instanceGroupRestructured;
  ...
  public void testAddAndRemoveInstancesFromGroup() throws IOException {
    ...
    Instance requestBody =
        new Instance().setName(instanceName).setZone("projects/" + projectId + "zones/" + ZONE)
            ...
            .newArrayList(
                new AttachedDisk().setType("PERSISTENT").setBoot(true).setMode("READ_WRITE")
                    ...
                    new AttachedDiskInitializeParams().setSourceImage(
                        ...
                        .setDiskType("projects/" + projectId + "/zones/" + ZONE
    ...
    Compute.Instances.Get getRequest =
        computeService.instances().get(projectId, ZONE, instanceName);
    ...
    Compute.Instances.Delete deleteInstance =
        computeService.instances().delete(projectId, ZONE, instanceName);
